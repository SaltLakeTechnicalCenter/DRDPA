...
\item Monitoring start time: \Sexpr{paste(TWA_start_time())}

\item Monitoring stop time: \Sexpr{paste(TWA_stop_time())}
...
{\includegraphics[width=18cm, height = 7cm]{sampling_time_plot}}
